...
CONTROLLER_REGISTRATION_GEN = $(shell pwd)/bin/controller-registration-gen
controller-registration-gen: ## Download controller-registration-gen if necessary.
	@[ -f $(CONTROLLER_REGISTRATION_GEN) ] || \
		wget -O $(CONTROLLER_REGISTRATION_GEN) -L https://raw.githubusercontent.com/gardener/gardener/v1.34.1/hack/generate-controller-registration.sh \
		&& chmod +x $(CONTROLLER_REGISTRATION_GEN)
